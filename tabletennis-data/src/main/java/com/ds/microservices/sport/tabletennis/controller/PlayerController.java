...
public class PlayerController {
	...
	// Save/update player
	@RequestMapping(value="/players/add", produces=MediaType.APPLICATION_JSON_UTF8_VALUE, method=RequestMethod.POST)
	...
	@RequestMapping(value="/players/activate", produces=MediaType.APPLICATION_JSON_UTF8_VALUE, method=RequestMethod.POST)
